...
import com.example.experiment1.databinding.ActivityCBinding
...
class ActivityC : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleAdapter = ArrayAdapter(this, R.layout.simple_list_item_1, lifecycleList)
        binding.lifecycleMethodList.adapter = lifecycleAdapter
        activityStatusAdapter = ArrayAdapter(this, R.layout.simple_list_item_1, activityStatus)
